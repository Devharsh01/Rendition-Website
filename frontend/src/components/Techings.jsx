...
const Techings = withLoadTracking(({onLoad}) => {
  ...
  return (
    <div id="Teachings" className="sticky top-0 w-full">
      ...
      {selected !== null ? (
        <div className="flex justify-center items-center h-full">
          ...
          >
            ...
            <motion.div
              className="relative w-full flex flex-row justify-center pt-2"
              variants={textVariant(0)}
              initial="hidden"
              whileInView="show"
              viewport={{ once: true, amount: 0.25 }}
            ...
            <div className="relative h-full md:h-auto flex flex-col-reverse md:flex-row justify-around md:justify-center items-center p-10 gap-4">
              ...
              <div className="relative w-full md:w-[60%] flex flex-row -top-[5%] ">
                <img
                  ...
                  alt=""
                  className="absoute z-10 w-[55%] h-auto object-cover rounded-lg "
                />
                <img
                  src={Object.values(extendedEmotions[selected].images)[1]}
                  alt=""
                  className="absolute z-10 top-[65%] left-[20%] w-[70%] h-full object-cover rounded-lg"
                />
                <img
                  src={Object.values(extendedEmotions[selected].images)[2]}
                  alt=""
                  className="absolute z-10 left-[60%] w-2/5 h-[130%] object-cover rounded-lg"
                />
              </div>
            </div>
          </div>
              ...
              className={`backward absolute left-0 top-0 h-full w-16 z-10 flex items-center justify-center transition-all duration-300 
                      ${
                        isAnimating
                          ...
                          : "bg-transparent hover:bg-red-800/30"
                      }`}
      ...
      <div className="w-full h-[80vh] text-center relative bg-[#080017] overflow-hidden">
        <div
          ...
          id="circle"
          onMouseEnter={() => {
            selected === null ? animationToggle("paused") : "";
          }}
          onMouseLeave={() => {
            selected === null ? animationToggle("running") : "";
          }}
          style={{
            "--quantity": extendedEmotions.length,
            "--rotation-duration": `100s`,
          }}
          ref={animationRef}
        >
