...
const RoleSelection = withLoadTracking(
  ({ onLoad, onBack, onSubmit, isSubmitting }) => {
    ...
    const handleRoleSelection = (role) => {
      ...
      if (selectedRole === role) {
        ...
        if (selectedRole) {
          ...
          const allAnswered = questions[selectedRole].every(
            (_, index) =>
    ...
    const handleAnswerChange = (index, value) => {
      ...
      const allAnswered = questions[selectedRole].every(
        (_, idx) =>
          newAnswers[selectedRole][idx] &&
          newAnswers[selectedRole][idx].trim() !== ""
      );
    ...
    return (
      <div className="relative flex flex-col items-center justify-between w-full min-h-screen py-6 sm:py-8 md:py-12 px-4 sm:px-6">
        <h1 className=" text-3xl sm:text-4xl md:text-5xl text-white text-center font-bold mt-2 mb-6 sm:mb-8 md:mb-12 tracking-tight drop-shadow-lg">
          <span className="sub-heading text-white">Choose Your Role</span>
        </h1>
                ...
                <motion.div
                  ...
                  ${
                    isSelected
                      ...
                      : isApplied
                      ? "bg-gradient-to-r from-[#4d2f8e] to-[#885ae5]"
            ...
            {selectedRole && (
              ...
              >
                <div className="flex flex-row justify-between">
                  <h2 className="text-content text-4xl sm:text-3xl text-gray-800 mb-4 sm:mb-6 font-bold">
                    {selectedRole}{" "}
                    <span className="text-content text-blue-600">
                      Questions
                    </span>
                  </h2>
                  <button
