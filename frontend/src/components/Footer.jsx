...
const Footer = withLoadTracking(({ onLoad }) => {
  return (
    <div className="relative w-full bg-gradient-to-br from-[#100030] via-[#080017] to-[#80001A] overflow-hidden py-8 sm:py-10 md:py-12 px-4 sm:px-6 md:px-12">
      ...
      <div className="relative max-w-7xl mx-auto">
        ...
        <div className="flex flex-col sm:flex-row gap-8 md:gap-10">
          ...
          <div className="w-full sm:w-1/2 flex flex-col justify-center">
            <h3 className="text-content text-2xl xs:text-3xl sm:text-3xl md:text-4xl lg:text-5xl font-bold text-white leading-tight mb-4 sm:mb-6">
              Where <span className="text-[#FF0033] heading">Dreams</span> Meet{" "}
              <span className="text-[#7738ff] heading">Reality</span>
            </h3>

            <p className="text-white/80 text-base sm:text-lg mb-4 sm:mb-6 max-w-md text-content">
              Join us on a journey of creativity and innovation. We're
              passionate about turning your ideas into extraordinary
              experiences.
            </p>
          </div>
          ...
          <div className="w-full sm:w-1/2 flex flex-col mt-6 sm:mt-0">
            <h2 className="text-2xl xs:text-2xl sm:text-2xl md:text-3xl font-bold text-white mb-4 sm:mb-6 inline-flex items-center">
              <span className="mr-2 heading">Contact Us</span>
              <span className="h-1 w-8 sm:w-12 bg-gradient-to-r from-red-400 to-purple-400 rounded-full"></span>
            </h2>

            <div className="grid grid-cols-1 md:grid-cols-2 gap-4 sm:gap-6 mb-6 sm:mb-8">
              {/* Team contact info */}
              <div className=" text-content bg-white/5 backdrop-blur-sm rounded-lg p-4 sm:p-5 border border-white/10">
                ...
                <div className="space-y-2 sm:space-y-3">
                  <div className="flex flex-col sm:flex-row md:flex-col items-start sm:items-center md:items-start">
                    <div className="text-white/90 w-full sm:w-32 font-medium">
                      Harshita Devnani
                    </div>
              ...
              {/* Connect section */}
              <div className="text-content bg-white/5 backdrop-blur-sm rounded-lg p-4 md:p-2 lg:p-5 border border-white/10">
                <h4 className="text-lg sm:text-xl font-semibold text-white mb-2 sm:mb-3">
                  Connect With Us
                </h4>
