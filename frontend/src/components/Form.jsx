...
const Form = withLoadTracking(({onLoad}) => {
  ...
  return (
    <div
      className="relative w-screen h-screen chalkFont flex justify-center flex-col gap-4"
      id="Form"
    >
      <video
        ref={videoRef}
      ...
      <div
        id="questions"
        className="relative flex flex-col w-full h-full justify-center items-center gap-5"
      >
        {/* Basic Details Input  */}
        <AnimatePresence mode="sync">
          {!isTransitioning && step === 1 && (
            ...
            >
              <h1 className="sub-heading text-4xl sm:text-5xl md:text-6xl lg:text-7xl text-white text-center font-thick sm:mt-8 mb-6 sm:mb-8">
                Want to Join Us?
              </h1>
                      ...
                      <g id="SVGRepo_iconCarrier">
                        ...
                        <g>
                          ...
                          <g>
                            ...
                            <g>
                              {" "}
                              <path d="M349.867,162.133h68.267c4.713,0,8.533-3.821,8.533-8.533c0-4.713-3.82-8.533-8.533-8.533h-68.267 c-4.713,0-8.533,3.821-8.533,8.533C341.333,158.313,345.154,162.133,349.867,162.133z"></path>{" "}
                              <path d="M418.133,213.333h-68.267c-4.713,0-8.533,3.82-8.533,8.533s3.821,8.533,8.533,8.533h68.267 c4.713,0,8.533-3.82,8.533-8.533S422.846,213.333,418.133,213.333z"></path>{" "}
                              <path d="M443.733,179.2H324.267c-4.713,0-8.533,3.82-8.533,8.533s3.82,8.533,8.533,8.533h119.467c4.713,0,8.533-3.82,8.533-8.533 S448.446,179.2,443.733,179.2z"></path>{" "}
                              <path d="M93.867,264.533h68.267c4.713,0,8.533-3.82,8.533-8.533s-3.821-8.533-8.533-8.533H93.867 c-4.713,0-8.533,3.82-8.533,8.533S89.154,264.533,93.867,264.533z"></path>{" "}
                              <path d="M162.133,332.8c4.713,0,8.533-3.82,8.533-8.533s-3.821-8.533-8.533-8.533H93.867c-4.713,0-8.533,3.82-8.533,8.533 s3.82,8.533,8.533,8.533H162.133z"></path>{" "}
                              <path d="M196.267,290.133c0-4.713-3.82-8.533-8.533-8.533H68.267c-4.713,0-8.533,3.82-8.533,8.533s3.82,8.533,8.533,8.533 h119.467C192.446,298.667,196.267,294.846,196.267,290.133z"></path>{" "}
                              <path d="M247.467,42.667h42.667c4.713,0,8.533-3.82,8.533-8.533s-3.821-8.533-8.533-8.533h-42.667 c-4.713,0-8.533,3.821-8.533,8.533S242.754,42.667,247.467,42.667z"></path>{" "}
                              <path d="M213.333,42.667h8.533c4.713,0,8.533-3.82,8.533-8.533s-3.821-8.533-8.533-8.533h-8.533 c-4.713,0-8.533,3.821-8.533,8.533S208.62,42.667,213.333,42.667z"></path>{" "}
        ...
        {showSuccessDialog && (
          <div className="fixed inset-0 flex items-center justify-center z-50 bg-black bg-opacity-70">
            <div className="bg-white p-6 rounded-lg max-w-md w-full mx-4 text-center">
              ...
              <h2 className="text-content text-2xl font-bold mb-4 text-gray-800">
                Submission Successful!
              </h2>
              <p className="text-content text-gray-600 mb-6">
                Your response has been recorded successfully.
              </p>
              <button
                onClick={handleSuccessDialogClose}
                className="text-content w-full py-2 px-4 bg-green-600 hover:bg-green-700 text-white rounded-lg transition-colors duration-300"
              >
                Continue
              </button>
            </div>
